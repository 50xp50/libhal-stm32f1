...
struct adc_reg_t
{
  ...
  static constexpr size_t regular_channel_length = 16;
...
static constexpr auto analog_watchdog_flag = hal::bit_mask::from<0>();
...
static constexpr auto injected_channel_end_of_conversion =
  hal::bit_mask::from<2>();

/// This bit is set by hardware when injected channel conversion starts. It is
/// cleared by software.
static constexpr auto injected_channel_start_flag = hal::bit_mask::from<3>();

/// This bit is set by hardware when regular channel conversion starts. It is
/// cleared by software.
static constexpr auto regular_channel_start_flag = hal::bit_mask::from<4>();
};  // namespace adc_status_register
...
static constexpr auto continuous_conversion = hal::bit_mask::from<1>();
...
/// initialized.
static constexpr auto reset_calibration = hal::bit_mask::from<3>();
...
static constexpr auto direct_memory_access_mode = hal::bit_mask::from<8>();
...
static constexpr auto data_alignment = hal::bit_mask::from<11>();

/// These bits select the external event used to trigger the start of conversion
/// of an injected group
static constexpr auto external_event_select_injected_group =
...
static constexpr auto external_trigger_conversion_mode_injected_channels =
  hal::bit_mask::from<15>();

/// These bits select the external event used to trigger the start of conversion
/// of a regular group.
static constexpr auto external_event_select_regular_group =
  hal::bit_mask::from<17, 19>();

/// This bit is set and cleared by software to enable/disable the external
/// trigger used to start conversion of a regular channel group.
static constexpr auto external_trigger_conversion_mode_regular_channel =
  hal::bit_mask::from<20>();
...
static constexpr auto start_conversion_injected_channels =
...
static constexpr auto start_conversion_regular_channels =
...
/// only in ADC1.
static constexpr auto temperature_sensor_and_reference_voltage_enable =
  hal::bit_mask::from<23>();
};  // namespace adc_control_register_2
...
static constexpr auto second_conversion = hal::bit_mask::from<5, 9>();

/// Third channel conversion in regular sequence
static constexpr auto third_conversion = hal::bit_mask::from<10, 14>();

/// Fourth channel conversion in regular sequence
static constexpr auto fourth_conversion = hal::bit_mask::from<15, 19>();

/// Fifth channel conversion in regular sequence
static constexpr auto fifth_conversion = hal::bit_mask::from<20, 24>();

/// Sixth channel conversion in regular sequence
static constexpr auto sixth_conversion = hal::bit_mask::from<25, 29>();
};  // namespace adc_regular_sequence_register_3
...
/// regular channels. The data is left or right-aligned depending on bit 11 in ADC_CR2.
...
static constexpr auto dual_mode_data = hal::bit_mask::from<16, 31>();
};  // namespace adc_regular_data_register
